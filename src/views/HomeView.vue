        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <h1 class="text-white">I'M Lincoln Burrows</h1>
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              ></v-btn
              ><br />
              <span class="text-caption">Saadat Abad , W Sarv Blvd</span
              ><br />
              <v-btn
              ...
              ></v-btn
              ><br />
              <span class="text-caption">021 - 4480 </span> <br />
              <span class="text-caption">021 - 4490 </span> <br />
              <v-btn
              ...
              ></v-btn
              ><br />
              <span class="text-caption">amirhosseinase@gmail.com </span> <br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
